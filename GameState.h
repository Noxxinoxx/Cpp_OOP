...
public:
     ...
     * copy constructor 
     */
    GameState(const GameState & object);
    /*
     * destructor
     */
    ~GameState();
     ...
     */
    GameState& operator=(const GameState & object);
    /*
...
private:
    ...
    //std::vector<Junk> junks;
    std::vector<Unit*> unitVector;                            // robots that have turned to junk
    Hero hero;                  // the hero
